...
Singleton {
    ...
    m3colors: QtObject {
        ...
        property color m3background: "#080B08"
        property color m3onBackground: "#DDF0B0"
        property color m3surface: "#0C110A"
        property color m3surfaceDim: "#080B08"
        property color m3surfaceBright: "#182013"
        property color m3surfaceContainerLowest: "#080B08"
        property color m3surfaceContainerLow: "#0C110A"
        property color m3surfaceContainer: "#10160F"
        property color m3surfaceContainerHigh: "#182013"
        property color m3surfaceContainerHighest: "#1E2917"
        property color m3onSurface: "#DDF0B0"
        property color m3surfaceVariant: "#182013"
        property color m3onSurfaceVariant: "#C8CDC8"
        property color m3inverseSurface: "#C8CDC8"
        property color m3inverseOnSurface: "#080B08"
        property color m3outline: "#96AA96"
        property color m3outlineVariant: "#182013"
        property color m3shadow: "#000000"
        property color m3scrim: "#000000"
        property color m3surfaceTint: "#B4FF00"
        property color m3primary: "#B4FF00"
        property color m3onPrimary: "#080B08"
        property color m3primaryContainer: "#273707"
        property color m3onPrimaryContainer: "#B4FF00"
        property color m3inversePrimary: "#AAD71E"
        property color m3secondary: "#EAFF00"
        property color m3onSecondary: "#080B08"
        property color m3secondaryContainer: "#313707"
        property color m3onSecondaryContainer: "#EAFF00"
        property color m3tertiary: "#39FF14"
        property color m3onTertiary: "#080B08"
        property color m3tertiaryContainer: "#11370A"
        property color m3onTertiaryContainer: "#39FF14"
        property color m3error: "#FF4D1F"
        property color m3onError: "#2A0A02"
        property color m3errorContainer: "#3A1206"
        property color m3onErrorContainer: "#FFC4B0"
        property color m3primaryFixed: "#B4FF00"
        property color m3primaryFixedDim: "#AAD71E"
        property color m3onPrimaryFixed: "#080B08"
        property color m3onPrimaryFixedVariant: "#c1c1c1"
        property color m3secondaryFixed: "#EAFF00"
        property color m3secondaryFixedDim: "#CDB964"
        property color m3onSecondaryFixed: "#080B08"
        property color m3onSecondaryFixedVariant: "#c1c1c1"
        property color m3tertiaryFixed: "#39FF14"
        property color m3tertiaryFixedDim: "#2BCB3F"
        property color m3onTertiaryFixed: "#080B08"
        property color m3onTertiaryFixedVariant: "#4e4447"
        property color m3success: "#39FF14"
        property color m3onSuccess: "#06320E"
        property color m3successContainer: "#0E3A18"
        property color m3onSuccessContainer: "#B6FFC4"
        property color term0: "#0C110A"
        property color term1: "#FF3B1A"
        property color term2: "#39FF14"
        property color term3: "#EAFF00"
        property color term4: "#2BD6A0"
        property color term5: "#FF7518"
        property color term6: "#4DFFC0"
        property color term7: "#C8CDC8"
        property color term8: "#4A5540"
        property color term9: "#FF3B1A"
        property color term10: "#39FF14"
        property color term11: "#DDF0B0"
        property color term12: "#2BD6A0"
        property color term13: "#FF7518"
        property color term14: "#4DFFC0"
        property color term15: "#F0FFD8"
    }
